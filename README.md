...
This Python code was written to support the case study for *Methylene Chloride* for the manuscript entitled ***Data engineering for tracking chemicals and releases at industrial end-of-life activities***.
...
| ------------- | ------------- |
| Sankey_5306.pdf | Figure 6: 6-level Sankey diagram  for the case study  |
| Box_5306.pdf  | Figure 7: Box plot for the case study  |
| Histogram_5306.pdf  | Figure 8: Histogram for the case study  |
